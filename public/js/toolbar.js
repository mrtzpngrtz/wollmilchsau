...
const Toolbar = {
      ...
      if (!e.ctrlKey && !e.metaKey) {
        switch (key) {
          ...
          case 'backspace':
            ...
            break;
          case 'escape':
            document.querySelectorAll('.canvas-element.img-pan-mode').forEach(el => el.classList.remove('img-pan-mode'));
  ...
  initActionButtons() {
    ...
    document.getElementById('btn-share').addEventListener('click', () => Storage.showShareModal());
  },
};
